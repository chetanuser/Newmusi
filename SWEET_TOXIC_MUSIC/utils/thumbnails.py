...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("SWEET_TOXIC_MUSIC/assets/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('SWEET_TOXIC_MUSIC/assets/font.ttf', 30)
            font2 = ImageFont.truetype('SWEET_TOXIC_MUSIC/assets/font2.ttf', 70)
            font3 = ImageFont.truetype('SWEET_TOXIC_MUSIC/assets/font2.ttf', 40)
            font4 = ImageFont.truetype('SWEET_TOXIC_MUSIC/assets/font2.ttf', 35)

            image4 = ImageDraw.Draw(image2)
            image4.text((10, 10), "ꜱᴡᴇᴇᴛ_ᴛᴏxɪᴄ_ᴍᴜꜱɪᴄ🫀🩸🖤", fill="white", font = font1, align ="left") 
